...
3. [ข้อกำหนดด้านฟังก์ชันการทำงาน](#3-ข้อกำหนดด้านฟังก์ชันการทำงาน)
   - [3.1 ระบบฐานข้อมูล Company Profile](#31-ระบบฐานข้อมูล-company-profile)
    ...
    - [3.2.9 UI การเลือกสินค้า](#329-ui-การเลือกสินค้าและการระบุรายละเอียด)
...
- **PR-F06**: ลบ Prospect (พร้อมยืนยันก่อนลบ, ปุ่มลบในหน้ารายการและหน้าแก้ไข, แสดง error ถ้ามี FK constraint)
...
- **CT-F06**: ลบลูกค้า (พร้อมยืนยันก่อนลบ, ปุ่มลบในหน้ารายการและหน้าแก้ไข, แสดง error ถ้ามี FK constraint)
- **CT-F07**: ดูประวัติ Quotation และใบเสร็จของลูกค้า
- **CT-F08**: ดูประวัติการติดต่อทั้งหมด
...
- **PD-F12**: ลบสินค้า (พร้อมยืนยันก่อนลบ, ปุ่มลบในหน้ารายการและหน้าแก้ไข, แสดง error ถ้ามี FK constraint)
...
- **Auto-fill:** เมื่อเลือกสินค้าจาก Dropdown จะ Auto-fill ชื่อสินค้า ราคาต่อหน่วย และรายละเอียด (description) โดยอัตโนมัติ
